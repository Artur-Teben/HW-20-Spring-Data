...
public class LaptopService {
    ...
    public void insertLaptops() {
        laptopRepository.save(laptopBuilder.buildModel("A715-41G-R7MZ").buildProducer("Acer")
        ...
        laptopRepository.save(laptopBuilder.buildModel("8RW14EA").buildProducer("HP")
        ...
        laptopRepository.save(laptopBuilder.buildModel("7DT87EA").buildProducer("HP")
        ...
        laptopRepository.save(laptopBuilder.buildModel("90NR0381-M01640").buildProducer("Asus")
        ...
        laptopRepository.save(laptopBuilder.buildModel("NX.HVGEU.006").buildProducer("Acer")
        ...
        laptopRepository.save(laptopBuilder.buildModel("I3582C54H5NIL-BK").buildProducer("Dell")
        ...
        laptopRepository.save(laptopBuilder.buildModel("90NB0PD6-M02540").buildProducer("Asus")
        ...
        laptopRepository.save(laptopBuilder.buildModel("MXK32UA/A").buildProducer("Apple")
        ...
        laptopRepository.save(laptopBuilder.buildModel("MXK72UA/A").buildProducer("Apple")
        ...
        laptopRepository.save(laptopBuilder.buildModel("81MX0035RA").buildProducer("Lenovo")
